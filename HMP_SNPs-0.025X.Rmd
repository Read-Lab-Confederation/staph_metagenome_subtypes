---
title: "Rare SNP analysis on HMP filtered at 0.025x coverage"
author: "Tim Read"
date: "August 14, 2015"
...
Pipeline is a bit messy but should be OK for now. Originally developed in script called  HMP_cooccuance.R.
...
Read in the daatframe from the HMP coverage analysis
...
```
###rare SNP enrichment between pairs of sites
```{r}
