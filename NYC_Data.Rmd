...
staph_df <- cbind(staph_df,Staph_betas$Sample.Id)
colnames(staph_df)[33] <- "Run"
staph_df_coords <- inner_join(NYCdata_SRA, staph_df, by = "Run")
```
...
for (i in colnames(staph_df)[1:32]){
